...
--
-- Host: localhost
-- Generation Time: Dec 17, 2019 at 12:30 PM
...
-- Database: `sentidiff`
--
CREATE DATABASE IF NOT EXISTS `sentidiff` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sentidiff`;
...
CREATE TABLE IF NOT EXISTS `remote_user_clientposts_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `remote_user_clientposts_model` (`id`, `tdesc`, `topics`, `sanalysis`, `senderstatus`, `ratings`, `userId_id`, `usefulcounts`, `uses`, `tgname`, `dislikes`, `names`) VALUES
(19, 'E commerce is one of the best web techniques for bank apps', '', 'positive', 'process', 25, 6, 0, 'To know about E commerce', 'ECommerce', -1, 'Ashok'),
(20, 'Now a days social network becomes very popular among all people.', '', 'nutral', 'process', 6, 7, 0, 'for communication between number of users', 'Social_Network', -3, 'Kumar'),
(21, 'Amaze after dark with the V17 rear camera''s Super Night Mode, featuring advanced noise reduction capabilities in its rear camera.', '', 'nutral', 'process', 4, 6, 0, 'Mobile for commucations', 'Vivo', -2, 'Ashok'),
(22, 'Samsung mobile are having goog Android GUI', '', 'nutral', 'process', 8, 11, 0, 'for communication between number of users', 'Samsung_Mobile', -1, 'Raghu'),
(23, 'Complete reference is always excellent for java leaning users', '', 'positive', 'process', 0, 12, 0, 'for java code development', 'Complete_reference', 0, 'Manjunath'),
(24, 'The Hindu is better news paper to know all news such as sports and politics news and cinema news', '', 'nutral', 'process', 1, 14, 0, 'used to know about news', 'Hindu_News', -1, 'tmksmanju'),
(25, 'It is good match for #Cricket when playing India Vs Pakistan', 'Cricket', 'positive', 'process', 0, 15, 0, 'to know about Cricket', 'Cricket', 0, 'Gopal');
...
(1, 'Ashok', 'It is very good article for java learners', 'positive', '2019-12-16 17:40:52.877804', 'Complete_reference', 'better to select this book article '),
(3, 'Manjunath', 'This mobile is having bad battery back up', 'negative', '2019-12-16 17:42:26.338742', 'Vivo', 'no suggestions'),
(4, 'Manjunath', 'Some people will buy this buy.pl suggest them about this mobile', 'neutral', '2019-12-16 17:43:30.730343', 'Vivo', 'no suggestions'),
(5, 'Manjunath', 'This is nice news paper', 'positive', '2019-12-16 17:52:18.015500', 'Hindu_News', 'no suggestions'),
(6, 'Manjunath', 'This is bad news papers', 'negative', '2019-12-16 17:52:36.916867', 'Hindu_News', 'no suggestions'),
(7, 'Manjunath', 'The maximum people are reading this news paper', 'neutral', '2019-12-16 17:53:09.954953', 'Hindu_News', 'no suggestions'),
(8, 'Raghu', 'Cricket is excellent match', 'positive', '2019-12-16 17:57:26.414914', 'Cricket', 'no suggestions'),
(9, 'Raghu', 'Cricket is worst while students are wring exams', 'negative', '2019-12-16 17:57:52.471554', 'Cricket', 'no suggestions'),
(10, 'Raghu', 'I used to listen cricket whenever i am free', 'neutral', '2019-12-16 17:58:12.376828', 'Cricket', 'no suggestions');
